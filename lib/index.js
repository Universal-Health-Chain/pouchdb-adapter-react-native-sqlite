...
const pouchdb_adapter_websql_core_1 = require("@universal-health-chain/pouchdb-adapter-websql-core");
var sqlite = null;
...
function ReactNativeSQLitePouch(opts, callback) {
    ...
    // @ts-ignore
    pouchdb_adapter_websql_core_1.WebSqlPouch.call(this, _opts, callback);
}
